...
import React, { useRef, useState, useEffect, useContext, createContext, ReactNode } from 'react'
...
export const Spotlight = ({
  ...
  return (
    <SpotLightContext.Provider value={{ ProximitySpotlight, HoverFocusSpotlight, CursorFlowGradient }}>
